"""
NSE Kotak Bank Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('kotakbank_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=KOTAKBANK"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_KOTAKBANK_OPTION_CHAIN_COLLECTION_NAME', 'kotakbank_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEKotakBankOptionChainCollector:
    """Collects and stores NSE Kotak Bank Option Chain data in MongoDB"""
