"""
NSE CANBK (Canara Bank) Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('canbk_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=CANBK"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_CANBK_OPTION_CHAIN_COLLECTION_NAME', 'canbk_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSECANBKOptionChainCollector:
    """Collects and stores NSE CANBK Option Chain data in MongoDB"""
