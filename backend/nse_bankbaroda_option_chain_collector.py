"""
NSE Bank of Baroda Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('bankbaroda_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=BANKBARODA"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_BANKBARODA_OPTION_CHAIN_COLLECTION_NAME', 'bankbaroda_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEBankBarodaOptionChainCollector:
    """Collects and stores NSE Bank of Baroda Option Chain data in MongoDB"""
