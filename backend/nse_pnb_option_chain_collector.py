"""
NSE PNB (Punjab National Bank) Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('pnb_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=PNB"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_PNB_OPTION_CHAIN_COLLECTION_NAME', 'pnb_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEPNBOptionChainCollector:
    """Collects and stores NSE PNB Option Chain data in MongoDB"""
