"""
NSE SBIN (State Bank of India) Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('sbin_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=SBIN"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_SBIN_OPTION_CHAIN_COLLECTION_NAME', 'sbin_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSESBINOptionChainCollector:
    """Collects and stores NSE SBIN Option Chain data in MongoDB"""
