"""
Cronjob Scheduler for NSE HDFC Bank Option Chain Data Collector
...
STATUS_FILE = 'hdfcbank_option_chain_scheduler_status.json'
...
def run_collector():
    """Execute the NSE HDFC Bank option chain data collector"""
    collector = None
    try:
        now = datetime.now()
        ...
        logger.error(f"HDFC Bank Option Chain Cronjob failed with error: {str(e)}")
