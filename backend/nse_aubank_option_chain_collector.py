"""
NSE AUBANK (AU Small Finance Bank) Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('aubank_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=AUBANK"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_AUBANK_OPTION_CHAIN_COLLECTION_NAME', 'aubank_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEAUBANKOptionChainCollector:
    """Collects and stores NSE AUBANK Option Chain data in MongoDB"""
