"""
NSE FEDERALBNK (Federal Bank) Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('federalbnk_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=FEDERALBNK"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_FEDERALBNK_OPTION_CHAIN_COLLECTION_NAME', 'federalbnk_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEFEDERALBNKOptionChainCollector:
    """Collects and stores NSE FEDERALBNK Option Chain data in MongoDB"""
