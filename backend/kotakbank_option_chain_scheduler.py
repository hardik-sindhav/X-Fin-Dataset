"""
Cronjob Scheduler for NSE Kotak Bank Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('kotakbank_option_chain_scheduler.log', encoding='utf-8'),
...
def run_collector():
    ...
    try:
        ...
        if success:
            logger.info("Kotak Bank Option Chain Cronjob completed successfully")
        else:
            logger.error("Kotak Bank Option Chain Cronjob completed with errors")
        ...
        logger.error(f"Kotak Bank Option Chain Cronjob failed with error: {str(e)}")
...
def main():
    ...
    logger.info("Starting NSE Kotak Bank Option Chain Data Collector Scheduler")
