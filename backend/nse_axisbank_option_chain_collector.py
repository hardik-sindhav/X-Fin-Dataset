"""
NSE Axis Bank Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('axisbank_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=AXISBANK"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_AXISBANK_OPTION_CHAIN_COLLECTION_NAME', 'axisbank_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEAxisBankOptionChainCollector:
    """Collects and stores NSE Axis Bank Option Chain data in MongoDB"""
