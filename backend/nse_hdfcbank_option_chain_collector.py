"""
NSE HDFC Bank Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('hdfcbank_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=HDFCBANK"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_HDFCBANK_OPTION_CHAIN_COLLECTION_NAME', 'hdfcbank_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEHDFCBankOptionChainCollector:
    """Collects and stores NSE HDFC Bank Option Chain data in MongoDB"""
