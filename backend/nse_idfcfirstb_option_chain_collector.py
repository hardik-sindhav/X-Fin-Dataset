"""
NSE IDFCFIRSTB (IDFC First Bank) Option Chain Data Collector
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('idfcfirstb_option_chain_collector.log', encoding='utf-8'),
...
# Configuration
EXPIRY_API_URL = "https://www.nseindia.com/api/option-chain-contract-info?symbol=IDFCFIRSTB"
...
MONGO_COLLECTION_NAME = os.getenv('MONGO_IDFCFIRSTB_OPTION_CHAIN_COLLECTION_NAME', 'idfcfirstb_option_chain_data')
MONGO_USERNAME = os.getenv('MONGO_USERNAME', None)
MONGO_PASSWORD = os.getenv('MONGO_PASSWORD', None)


class NSEIDFCFIRSTBOptionChainCollector:
    """Collects and stores NSE IDFCFIRSTB Option Chain data in MongoDB"""
